...
def most_and_least_common_type(treats):
    ...
    Return most and least common treat types in tuple of format (most, least).
        ...
        >>> treats = [{'who': 'Leslie', 'type': 'dessert', 'description': 'Chocolate mousse'}, {'who': 'Joel', 'type': 'dessert', 'description': 'Cardamom-Pear pie'}, {'who': 'Meggie', 'type': 'appetizer', 'description': 'Humboldt Fog cheese'}, {'who': 'Bonnie', 'type': 'dessert', 'description': 'Lemon bars'}, {'who': 'Katie', 'type': 'appetizer', 'description': 'Mini-enchiladas'}, {'who': 'Anges', 'type': 'drink', 'description': 'Sangria'}, {'who': 'Henry', 'type': 'dessert', 'description': 'Chocolate-raisin cookies'}, {'who': 'Sarah', 'type': 'dessert', 'description': 'Brownies'}]
        >>> most_and_least_common_type(treats)
        ('dessert', 'drink')

        >>> treats = [{'who': 'Leslie', 'type': 'drink', 'description': 'Chocolate mousse'}, {'who': 'Joel', 'type': 'drink', 'description': 'Cardamom-Pear pie'}, {'who': 'Meggie', 'type': 'drink', 'description': 'Humboldt Fog cheese'}, {'who': 'Bonnie', 'type': 'dessert', 'description': 'Lemon bars'}, {'who': 'Katie', 'type': 'appetizer', 'description': 'Mini-enchiladas'}, {'who': 'Anges', 'type': 'drink', 'description': 'Sangria'}, {'who': 'Henry', 'type': 'dessert', 'description': 'Chocolate-raisin cookies'}, {'who': 'Sarah', 'type': 'dessert', 'description': 'Brownies'}]
        >>> most_and_least_common_type(treats)
        ('drink', 'appetizer')
        ...
        >>> treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'drink'}, {'type': 'app'}]
        ('dessert', 'app')

        """
    
    #treats is a list of dictionaries
    ...
    for treat in treats:
        # creating a new key that is the type of treat and we are incrementing that type
